...
//this is where we're setting up our host request
...
const handleSubmit = async (ev) => {}
  ...
  return (
    <div>
      ...
      // this means that the button is disabled if processing, disabled or succeeded is true
      id='submit'
      options={cardStyle}
      //note that options is a feature that comes with the component that comes with stripe
       >
        <span id='button-text'>
